...
//        Log.d("SoapRequest", request.toString());
     ...
     * @return the soap object
     */
    public static SoapObject DataSetTrans(SoapObject soapObject) {
        SoapObject result = null;
     ...
     * @return the string
     */
    public static String StringTrans(SoapObject soapObject) {
        String result = null;
        if (soapObject != null && soapObject.getPropertyCount() > 0) {
     ...
     * @return the integer
     */
    public static int IntTrans(SoapObject soapObject) {
        int result = -3;
        if (soapObject != null && soapObject.getPropertyCount() > 0) {
